  ...
  return {
    tools: [
        ...
        inputSchema: {
          ...
          properties: {
            keyword: {
              type: "string",
              description:
                "Search keyword (e.g., 'Taylor Swift', 'NBA Lakers', 'Hamilton')",
            },
            location: {
              type: "string",
              description:
                "Location to search near (e.g., 'New York, NY', 'Los Angeles', '90001')",
            },
            startDate: {
              type: "string",
      ...
      },
      {
        ...
        description:
          "Get detailed information about a specific event by event ID or URL.",
        inputSchema: {
          type: "object",
          properties: {
            eventId: {
              type: "string",
              description:
                "Ticketmaster event ID (e.g., 'Z698xZC2Z17aVaQe') or full event URL",
            },
          },
          required: ["eventId"],
        },
        ...
        inputSchema: {
          ...
          properties: {
            location: {
              type: "string",
              description:
                "Location to search near (e.g., 'New York, NY', 'Chicago', '60601')",
            },
            maxResults: {
              type: "number",
      ...
      },
      {
        ...
        description:
          "Get detailed information about a specific venue by venue ID or URL.",
        inputSchema: {
          type: "object",
          properties: {
            venueId: {
              type: "string",
              description:
                "Ticketmaster venue ID or full venue URL",
            },
          },
          required: ["venueId"],
        },
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            eventId: {
              type: "string",
              description: "Ticketmaster event ID or full event URL",
            },
          },
          required: ["eventId"],
        },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            quantity: {
              type: "number",
              description: "Number of tickets to select",
            },
            section: {
              type: "string",
              description:
                "Preferred section name (optional - will use best available if not specified)",
            },
            maxPrice: {
              type: "number",
              description: "Maximum price per ticket in USD (optional)",
            },
          },
      ...
      },
      {
        ...
        description:
          "Add tickets to the Ticketmaster cart for an event.",
        inputSchema: {
          type: "object",
          properties: {
            eventId: {
            ...
            section: {
              type: "string",
              description:
                "Preferred section (optional - will use best available if not specified)",
            },
          },
          required: ["eventId", "quantity"],
        },
      },
      {
        ...
        description:
          "View current Ticketmaster cart contents, including events, seats, and totals.",
        inputSchema: {
          type: "object",
          properties: {},
        },
      ...
      },
      {
        ...
        description:
          "Get Ticketmaster order history. Requires being logged in.",
        inputSchema: {
          type: "object",
          properties: {
            maxResults: {
  ...
  try {
    switch (name) {
      ...
      case "ticketmaster_search_events": {
        const { keyword, location, startDate, endDate, maxResults = 20 } =
          args as {
            keyword: string;
            location?: string;
            startDate?: string;
      ...
      case "ticketmaster_get_venues": {
        ...
        const venues = await getVenuesNearLocation(location, Math.min(maxResults, 20));
      ...
      case "ticketmaster_check_availability": {
        const { eventId } = args as { eventId: string };
        const availability = await checkTicketAvailability(eventId);
      ...
      case "ticketmaster_select_seats": {
        ...
        const selected = await selectSeats(eventId, quantity, section, maxPrice);
      ...
      case "ticketmaster_add_to_cart": {
        ...
        const result = await addToCart(eventId, quantity, section);
      ...
      case "ticketmaster_get_orders": {
        ...
        const orders = await getOrders(Math.min(maxResults, 50));
          ...
          text: JSON.stringify(
            {
              success: false,
              error: errorMessage,
              suggestion: errorMessage.includes("login") ||
...
async function main() {
  ...
  console.error("Strider Ticketmaster MCP server running");
