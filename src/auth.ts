/**
 * Strider Labs - Ticketmaster Auth/Session Management
 *
 * Handles cookie persistence and session management for Ticketmaster.
 */
...
const CONFIG_DIR = path.join(os.homedir(), ".strider", "ticketmaster");
